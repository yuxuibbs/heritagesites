...
class Location(models.Model):
    ...
    def __str__(self):
        return '{} | {} | {} | {}'.format(self.planet if self.planet else '', self.region if self.region else '', self.sub_region if self.sub_region else '', self.intermediate_region if self.intermediate_region else '')
